...
class DetailsActivity : AppCompatActivity() {
    ...
    val cheetahInfo = "Cheetahs are iconic cats, famous for their speed and strength. " +
            "They are also somewhat singular animals – they have several differences to the " +
            "majority of the feline species"
    val lionInfo = "Lions have strong, compact bodies and powerful forelegs, teeth, and jaws " +
            "for pulling down and killing prey. Their coats are yellow-gold. Adult males have " +
            "shaggy manes that range in color from blond to reddish-brown to black and also " +
            "vary in length."
